(function () {
	...
	*/
	...
	var parseHeader = /*@__PURE__*/getDefaultExportFromCjs(parseHeaders);
	...
	class Axios {
	    ...
	    request(config) {
	        ...
	        const chain = [{ onFulfilled: this.dispatchRequest }]; // 请求的真实逻辑
	        ...
	        let promise = Promise.resolve(config); // 我们构建一个每次执行后返回的promise
	            ...
	            request.onreadystatechange = () => {
	                ...
	                if (request.readyState === 4 && request.status !== 0) {
	                    ...
	                    if (request.status >= 200 && request.status < 300) {
	                        ...
	                        reject("my errorAxiosError: Request failed with status code " +
	                            request.status);
	                    }
	                }
	            };
